							...
							<ul class="wptreehouse-badges">
								...
								<li>
									<ul>
										...
										<?php if ($wptreehouse_profile->{'badges'}[$i]->{'name'} != 'Newbie' ) : ?>
				...
				<?php if( isset($wptreehouse_username) || $wptreehouse_username != ''): ?>
					...
					<div class="postbox">
						...
						<div class="inside">
							...
							<p><img width="100%" src="<?php echo $wptreehouse_profile->{'gravatar_url'} ;?>" alt="<?php echo $wptreehouse_profile->{'name'} ;?>'s Gravatar"></p>
